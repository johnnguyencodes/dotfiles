return {
  ...
  config = function ()
    ...
    path = os.getenv "HOME" .. "/.config/nvim/lua/johnnyfiive/plugins/"
    ...
    dashboard.section.footer.val = WEEKDAYS[getDayOfWeek()]
    -- Set menu
    -- dashboard.section.buttons.val = {
      --   dashboard.button("<leader>pf", "󰱼  > Find file", ":Telescope find_files <CR>"),
      -- } 
